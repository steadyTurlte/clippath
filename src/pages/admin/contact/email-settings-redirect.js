...
const EmailSettingsRedirect = () => {
  ...
  return (
    <AdminLayout>
      <Head>
        <title>Redirecting to Settings | Photodit Admin</title>
      </Head>
      ...
      <div className="admin-redirect">
        <div className="admin-redirect__content">
          ...
          <h1 className="admin-redirect__title">Redirecting to Settings Page</h1>
          <p className="admin-redirect__message">
            Email settings have been moved to the main Settings page. You will be redirected automatically.
          </p>
          <Link href="/admin/settings" className="admin-redirect__link">
